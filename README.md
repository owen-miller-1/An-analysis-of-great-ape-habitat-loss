...
## Overview
This project examines 25 years (2001-2025) of satellite-derived tree cover loss across the core range of great ape genera: orangutans, gorillas, chimpanzees and bonobos. It spans 13 countries across equatorial Africa and Southeast Asia. The analysis combines Hansen Global Forest Change data, WDPA protected area boundaries, and IUCN species ranges to quantify how much great ape habitat is contained within protected areas, and whether protection is associated with reduced forest loss.
